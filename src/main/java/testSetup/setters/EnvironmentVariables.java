...
public interface EnvironmentVariables {
    ...
    static int getWaitForTime_static() {
        return Integer.parseInt(System.getProperty(Settings.WAIT_FOR_TIME, String.valueOf(WAIT_FOR_TIME)));
    }
    ...
    static boolean isIncognitoNeeded() {
        ...
        if (incognitoNeeded == true || incognitoNeeded == false) return incognitoNeeded;
